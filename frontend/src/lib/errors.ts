...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  period_month_invalid: '核算月份必须选择月份首日',
  performance_payment_not_pending: '所选收款已入账、已取消或已作废，请刷新后重试',
  performance_payment_outside_month: '所选收款不属于当前核算月份',
  performance_sales_record_inactive: '所选收款对应的销售记录不可入账',
  performance_allocation_total_invalid: '收款的美导分配金额与收款金额不一致',
